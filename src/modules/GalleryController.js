export default class GalleryController {
    ...
    createCardElement(item, index) {
        ...
        img.onerror = () => {
            ...
            // Elite Visuals: SVG Icon for error state (Static content only)
            errorDiv.innerHTML = `
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="image-error-icon">
                    <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                    <circle cx="8.5" cy="8.5" r="1.5"></circle>
                    <polyline points="21 15 16 10 5 21"></polyline>
                    <line x1="3" y1="3" x2="21" y2="21"></line>
                </svg>
                <span class="image-error-text">Image Unavailable</span>
            `;
